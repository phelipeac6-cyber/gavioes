...
import mapImage from "@/assets/map-placeholder.png"; // Placeholder image for the map
      ...
      <main className="p-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-8">
          ...
          <div className="bg-white p-6 rounded-2xl">
            ...
            <img src={mapImage} alt="Mapa de torcedores" className="w-full h-full object-cover rounded-lg" />
          </div>
        </div>
